...
public class CatalogManagerImpl implements CatalogManager {
    ...
    /** Default Logger * */
    private final static Logger LOGGER = org.geotools.util.logging.Logging.getLogger(CatalogManagerImpl.class);
    
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createCatalog(org.geotools.gce.imagemosaic.catalogbuilder.CatalogBuilderConfiguration)
     */
    @Override
    public GranuleCatalog createCatalog(CatalogBuilderConfiguration runConfiguration) throws IOException {
        return createCatalog(runConfiguration, true);
    }

    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createCatalog(org.geotools.gce.imagemosaic.catalogbuilder.CatalogBuilderConfiguration, boolean)
     */
    @Override
    public GranuleCatalog createCatalog(CatalogBuilderConfiguration runConfiguration, boolean create) throws IOException {
        //
        // create the index
        //
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#dropDatastore(java.io.File)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createGranuleCatalogProperties(java.io.File)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createGranuleCatalogFromDatastore(java.io.File, java.io.File, boolean, org.geotools.factory.Hints)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createGranuleCatalogFromDatastore(java.io.File, java.io.File, boolean, boolean, org.geotools.factory.Hints)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createGranuleCatalogFromDatastore(java.io.File, java.util.Properties, boolean, boolean, org.geotools.factory.Hints)
     */
    @Override
    public GranuleCatalog createGranuleCatalogFromDatastore(File parent,
    ...
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createSchema(org.geotools.gce.imagemosaic.catalogbuilder.CatalogBuilderConfiguration, java.lang.String, org.opengis.referencing.crs.CoordinateReferenceSystem)
     */
    @Override
    public SimpleFeatureType createSchema(CatalogBuilderConfiguration runConfiguration, String name,
        ...
        if (indexSchema == null) {            
            indexSchema = createDefaultSchema(runConfiguration, name, actualCRS);
        }
        return indexSchema;
    }
    
    /* (non-Javadoc)
     * @see org.geotools.gce.imagemosaic.CatalogManager#createDefaultSchema(org.geotools.gce.imagemosaic.catalogbuilder.CatalogBuilderConfiguration, java.lang.String, org.opengis.referencing.crs.CoordinateReferenceSystem)
     */
    @Override
     ...
     */
    protected void addAttributes(String attribute, SimpleFeatureTypeBuilder featureBuilder,
            Class<?> classType) {
        if (attribute != null) {
     ...
     * @return
     */
    protected boolean isCaseSensitiveFileSystem(File fileBeingProcessed) {
     ...
     * @param propertiesCollectors
     */
    protected void updateAttributesFromCollectors(
     ...
     * @throws IOException
     */
    protected String prepareLocation(CatalogBuilderConfiguration runConfiguration, final File fileBeingProcessed) throws IOException {
        // absolute
     ...
     * @throws IOException 
     */
    protected void checkTypeName(URL sourceURL, MosaicConfigurationBean configuration) throws IOException {
     ...
     * @throws IOException 
     */
    public GranuleCatalog createCatalog(final URL sourceURL, final MosaicConfigurationBean configuration, Hints hints) throws IOException {
        CatalogConfigurationBean catalogBean = configuration.getCatalogConfigurationBean();
